...
**MetricsHub** sends the collected metrics to a Prometheus server using the _Remote Write Protocol_.
...
1. First, configure your Prometheus server to allow the the _Remote Write_ feature:
