...
| `ExecuteHttpQuery`               | <ul><li>`url` (list&lt;string&gt;, **required**)</li> <li>`method` (string, _optional_, default: *GET*)</li> <li>`headers` (string, _optional_)</li> <li>`body` (string, _optional_)</li> <li>`timeout` (integer, _optional_, default: _10s_)</li> <li>`poolSize` (integer, _optional_, default: _60 threads_)</li></ul>                                                          | Executes HTTP requests for one or more URLs and optionally includes custom headers, a request body, a timeout value, and concurrent execution settings. Except HTTP GET, all the other methods are disabled by default. |
| `ExecuteIpmiQuery`               | <ul><li>`hostname` (list&lt;string&gt;, **required**)</li> <li>`timeout` (integer, _optional_, default: _10s_)</li> <li>`poolSize` (integer, _optional_, default: _60 threads_)</li></ul>                                                                                                                                                                                         | Executes an IPMI query on the given hosts with the given timeout.                                                                                                                                                       |
| `ExecuteSnmpQuery`               | <ul><li>`hostname` (list&lt;string&gt;, **required**)</li> <li>`queryType` (string, **required**)</li> <li>`oid` (string, **required**)</li> <li>`columns` (string, _optional_)</li> <li>`timeout` (integer, _optional_, default: _10s_)</li> <li>`poolSize` (integer, _optional_, default: _60 threads_)</li></ul>                                                               | Executes an SNMP query (Get, GetNext, Walk, or Table) on the given hosts using the specified OID. For `table` queries, comma-separated column indexes need to be provided.                                              |
| `ExecuteSshCommandline`          | <ul><li>`hostname` (list&lt;string&gt;, **required**)</li> <li>`commandline` (string, **required**)</li> <li>`timeout` (integer, _optional_, default: _10s_)</li> <li>`poolSize` (integer, _optional_, default: _60 threads_)</li></ul>                                                                                                                                           | Executes the specified commandline through SSH on the given hosts. This service is disabled by default.                                                                                                                 |
| `ExecuteWinRemoteCommand`        | <ul><li>`hostname` (list&lt;string&gt;, **required**)</li> <li>`commandline` (string, **required**)</li> <li>`protocol` (string, **required**)</li> <li>`timeout` (integer, _optional_, default: _10s_)</li> <li>`poolSize` (integer, _optional_, default: _60 threads_)</li></ul>                                                                                                | Executes a Windows OS command (CMD command) on one or more Windows hosts using WMI or WinRM protocol. This service is disabled by default.                                                                              |
| `ExecuteWqlQuery`                | <ul><li>`hostname` (list&lt;string&gt;, **required**)</li> <li>`protocol` (string, **required**)</li> <li>`query` (string, **required**)</li> <li>`namespace` (string, _optional_, default: _root/cimv2_ for WBEM and _root\cimv2_ otherwise)</li> <li>`timeout` (integer, _optional_, default: _10s_)</li> <li>`poolSize` (integer, _optional_, default: _60 threads_)</li></ul> | Executes a WQL/CIM query on Windows or WBEM-compatible hosts using the specified protocol (WBEM, WMI, or WinRM) and namespace.                                                                                          |
...
> **Important:** Some MCP clients require **HTTPS with a valid TLS certificate**. If so, keep **HTTPS enabled** on your **MetricsHub** instance and ensure the client **trusts the SSL certificate** (see [Updating the SSL certificate](../operating-web-ui.md#updating-the-ssl-certificate)). If you use a reverse proxy, forward requests to the **MetricsHub MCP Server** on port `31888`.

## Configuring the integration

Configure your AI assistant to connect to `https://<hostname>:31888/sse`. Make sure to replace `<hostname>` with the actual hostname or IP address of the machine where **MetricsHub** is running.
