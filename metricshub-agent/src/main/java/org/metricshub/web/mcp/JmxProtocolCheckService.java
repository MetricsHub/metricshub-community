...
public class JmxProtocolCheckService {
	...
	public ProtocolCheckResponse checkJmxProtocol(
		...
		return agentContextHolder
			...
			.map((IProtocolExtension extension) -> checkJmxWithExtension(hostname, timeout, extension))
			.orElse(
