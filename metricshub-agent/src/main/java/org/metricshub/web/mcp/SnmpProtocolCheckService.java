...
public class SnmpProtocolCheckService {
	...
	public ProtocolCheckResponse checkSnmpProtocol(
		...
		return agentContextHolder
			...
			.map((IProtocolExtension extension) -> checkSnmpWithExtension(hostname, timeout, extension))
			.orElse(
