...
/**
 * REST API to expose the agent hierarchy and its resource-groups and monitored resources.
 */
@RestController
...
public class ExplorerController {
	 ...
	 *
	 * @param explorerService service that assembles the hierarchy from the current AgentContext
	 */
