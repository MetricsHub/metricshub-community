...
/** Material Symbols Outlined "database" (Apache-2.0). */
const DATABASE_ICON_PATH =
...
/**
 * Material Symbols database icon (stacked cylinder), distinct from MUI Storage/Dataset.
 *
 * @param {import("@mui/material").SvgIconProps} props
 */
const DatabaseIcon = (props) => (
	<SvgIcon viewBox="0 -960 960 960" {...props}>
		<path d={DATABASE_ICON_PATH} />
	</SvgIcon>
);
