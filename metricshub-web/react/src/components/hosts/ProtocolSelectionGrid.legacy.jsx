...
/**
 * Legacy multi-select protocol picker (compact chips).
 * Kept for revert — swap the import in HostConfigBasicsSection to use this component again.
 *
 * @param {object} props
 ...
 */
const ProtocolSelectionGridLegacy = ({
	value = [],
	onChange,
	error = false,
	helperText,
...
export default ProtocolSelectionGridLegacy;
