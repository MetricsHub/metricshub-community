...
export default function EditorHeader({ selected, saving, validation, onValidate, onSave, canSave }) {
  return (
    <Stack direction="row" alignItems="center" justifyContent="space-between">
      ...
      <Stack direction="row" spacing={1} alignItems="center">
        ...
        <Button size="small" onClick={onValidate} disabled={!selected}>Validate</Button>
        <Button
          size="small"
          startIcon={<SaveIcon />}
          onClick={onSave}
