 ...
 *  - activeTree?: string                       // which tree key to render
 *  - trees?: Record<string, React.ReactNode>   // registry of trees (optional)
 *  - emptyState?: React.ReactNode              // optional custom empty-state node
 */
