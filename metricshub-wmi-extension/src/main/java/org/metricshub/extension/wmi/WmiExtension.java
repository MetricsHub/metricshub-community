...
import org.metricshub.extension.win.source.FileSourceProcessor;
...
public class WmiExtension implements IProtocolExtension {
	...
	public Set<Class<? extends Source>> getSupportedSources() {
		return Set.of(WmiSource.class, CommandLineSource.class, EventLogSource.class, FileSource.class);
	}

	@Override
	public Map<Class<? extends IConfiguration>, Set<Class<? extends Source>>> getConfigurationToSourceMapping() {
		return Map.of(WmiConfiguration.class, Set.of(WmiSource.class, EventLogSource.class, FileSource.class));
	}
	...
	/**
	 * Executes a WMI query on the specified host and returns the result as a formatted text table.
	 ...
	 * @param wmiConfiguration   The WMI configuration containing authentication credentials and settings.
	...
	private String executeWmiQuery(
		...
		final WmiConfiguration wmiConfiguration,
		final String query,
