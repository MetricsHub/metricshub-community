 ...
 *
 * <p>The message is intended to be operator-facing and should clearly name the connector and the
 * expected JAR ({@code driverJarHint}) when raised from a connector-driven resolution.
 */
