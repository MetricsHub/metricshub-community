	...
	void testNormalize() {
		{
			...
			final NumberMetric hwOtherDeviceUsesMetric = NumberMetric.builder()
				.value(1.0)
			...
			final NumberMetric hwOtherDeviceUsesLimitCriticalMetric = NumberMetric.builder()
				.value(2.0)
			...
			final NumberMetric hwOtherDeviceUsesLimitDegradedMetric = NumberMetric.builder()
				.value(1.0)
			...
			final Monitor monitorWithHwOtherDeviceUsesLimitMetric = Monitor.builder()
				.id("monitorOne")
				.type("other_device")
				.metrics(
					new HashMap<>(
			...
			new OtherDeviceMetricNormalizer(STRATEGY_TIME, HOSTNAME, new ConnectorStore()).normalize(
